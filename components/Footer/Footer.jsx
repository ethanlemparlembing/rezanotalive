      ...
      <div className='mx-auto h-full w-full max-w-6xl p-5'>
        <div className='flex h-full flex-col justify-between border-[1.5px]'>
          <div className='flex h-full w-full flex-col-reverse md:flex-row'>
            <div className='container max-w-md p-5 sm:p-10'>
              <div className='space-y-10'>
                ...
                <button className='l inline-flex w-40 items-center justify-center border-[1.5px] border-white px-4 py-3 text-sm font-semibold hover:bg-white hover:text-black'>
                  Get In Touch
                </button>
              </div>
            </div>
            <div className='container flex w-full flex-col justify-between sm:flex-row'>
              <div className='space-y-3 p-5 sm:p-10'>
                <h2 className='font-semibold'>The heading</h2>
                <ul className='flex w-full flex-row justify-between sm:flex-col'>
                  <li>
                    <a
                      href=''
          ...
          <div className='flex w-full flex-col-reverse items-center justify-between gap-5 border-t-[1.5px] p-5 sm:flex-row sm:p-10'>
            ...
            <div className='flex w-full items-center justify-between gap-1 sm:justify-end sm:gap-5'>
