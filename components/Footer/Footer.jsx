    ...
    <div className='flex min-h-[calc(100vh-4rem)] items-center bg-black text-white'>
      <div className='mx-auto flex w-full max-w-6xl flex-col gap-10 p-5 sm:gap-20'>
        <div className='flex flex-col gap-10 sm:flex-row'>
          ...
          <div className='container mx-auto hidden max-w-full flex-col gap-5 sm:flex'>
            <h2 className=' text-lg font-bold  capitalize md:text-sm lg:text-xl'>
              sitemap
            </h2>
          ...
          <div className='mx-auto hidden max-w-full flex-col gap-5 sm:flex'>
            <h2 className=' text-lg font-bold  capitalize md:text-sm lg:text-xl'>
              Projects
            </h2>
            <div className='flex flex-col gap-3'>
